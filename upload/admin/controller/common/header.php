...
class Header extends Controller {
    ...
    public function index() {
        ...
        if (!isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
            ...
            // Returns
            $this->load->model('sale/salereturn');

            $return_total = $this->model_sale_salereturn->getTotalReturns(array('filter_return_status_id' => $this->config->get('config_return_status_id')));
